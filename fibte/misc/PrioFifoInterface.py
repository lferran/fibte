...
class PrioFifoIntf(TCIntf):
    """
    Customized TC class for the Datacenter network. It will have a special TC tree
    designed for our purposes. Specifically, we've got 3 main classes of traffic,
    ordered by priority:

    1) ICMP packets
    2) OSPF and TCP syn+ack packets
    3) Remaining traffic

    To the latter class, we want a FIFO queue!
    """
    def __init__(self, *args,**kwargs):
        super(PrioFifoIntf,self).__init__(*args,**kwargs)
    ...
    def bwCmds(self, bw=None, speedup=0, use_hfsc=False, use_tbf=False,
        ...
        if bw and (bw < 0 or bw > self.bwParamMax):
            ...
            #    - At the end of class 2: a SFQ is attached
            #    - At the end of class 3: a FIFO is attached for the remaining traffic
            ...
            # We add the final leaf-queues here
